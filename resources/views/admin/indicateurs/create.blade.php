...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <!-- SELECT2 EXAMPLE -->
                <form  method="post" action="{{url('indicateur/create/store')}}" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="category_name">Objectifs<span style="color: red"> *</span></label>
                                        <select name="role" id="role" class="form-control select2" style="width: 100%;">
                                            <option selected="selected" disabled value ="" >-- choisi  un objectif --</option>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="name">Nom Indicateur<span style="color: red"> *</span></label>
