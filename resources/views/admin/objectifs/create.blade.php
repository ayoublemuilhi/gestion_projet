    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Objectifs</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
        ...
        <section class="content">
            ...
            <!-- SELECT2 EXAMPLE -->
                <form  method="post" action="{{url('objectif/create/store')}}" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="category_name">Secteur<span style="color: red"> *</span></label>
                                        <select name="role" id="role" class="form-control select2" style="width: 100%;">
                                            <option selected="selected" disabled value ="" >-- choisi  un secteur --</option>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="name">Nom Objectif<span style="color: red"> *</span></label>
